...
try:
    ...
    print(
        "Please provide the username and browserstack access key as command line arguments."
    )
    sys.exit(1)
...
opt.add_extension(extension=os.path.join(os.path.dirname(__file__), "..", "addon"))
