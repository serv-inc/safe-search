...
describe("Addon", function () {
  describe("should alter search URLs to use safe search", function () {
    it("for Google", function () {
      const uri = "http://google.de/search?q=test";
  ...
  describe("should clean duplicate parameters", function () {
    it("for Google", function () {
      const uri = "http://google.de/search?q=test&safe=vss";
    ...
    it("for Google triplicate", function () {
      const uri = "http://google.de/search?q=test&safe=vss&safe=vss";
    ...
    it("for Google triplicate with other stuff in-between", function () {
      const uri =
        "http://google.de/search?q=test&safe=vss&hello=world&safe=vss";
    ...
    it("for Google triplicate with different values", function () {
      const uri =
        "http://google.de/search?q=test&safe=active&hello=world&safe=off";
  ...
  describe("should use _metaAdd correctly", function () {
    it("for uri containing correct params", function () {
      ...
      expect(_metaAdd(URI_WITH, ["ssui", "safe"], ["on", "active"])).toEqual(
        false
      );
    });
    it("for uri not containing correct params", function () {
      expect(_metaAdd(URI_WITHOUT, ["safe", "ssui"], ["active", "on"])).toEqual(
        URI_WITH
      );
    });
  });
